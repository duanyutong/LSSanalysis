...
if __name__ == '__main__':
    ...
    # read in data
    c = np.loadtxt(datadir+ft+zb+'covariance_monoquad_'+bc)     # combined monopole, quadrupole cov matrix
    ...
    ans = Xism_arat_1C_an(dv, invc, rl, mod, dvb, invcb, rlb, spar=0.003, spat=0.003)
    with open(os.path.join(Hdir, '2Dbaofits', 'confidence_region.pkl'), 'wb') as handle:
